...
\ifthenelse{\isundefined{\gnumericColA}}{\newlength{\gnumericColA}}{}\settowidth{\gnumericColA}{\begin{tabular}{@{}p{126pt*\gnumericScale}@{}}x\end{tabular}}
...
\hhline{|-|-|-|-|-|-|-}
	...
	{\gnumericPB{\raggedright}\textbf{Political Party}}
...
\hhline{|-------|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\textbf{Seats Won}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}75}
	&\multicolumn{1}{p{\gnumericColC}|}%
